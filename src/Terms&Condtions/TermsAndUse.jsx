    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          experience purchasing from our webstore, Kriptees.com.
        </p>
        <p>
        ...
        <p>
          ...
          agreed to or set forth in writing by Kriptees, any term or
        ...
        <h2>Orders</h2>
        <p>
          All orders are subject to Kriptees's acceptance. This means
          Kriptees may, for any reason, refuse to accept or may cancel or
          ...
          cancel an order after you have already been charged, Kriptees
        ...
        <p>
          ...
          and it is accepted by Kriptees. Prices for products displayed on
          ...
          website may differ from those in stores that stock Kriptees
          products, as these stores are independent of Kriptees.
          Kriptees reserves the right to amend pricing for any pricing
          ...
          submitted an online order, Kriptees will notify you of the error
        ...
        <p>
          ...
          Kriptees reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse Kriptees if it pays, any
          taxes, except for those based on Kriptees's income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by Kriptees for when the
          ...
          are beyond our control. Kriptees cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by Kriptees, customer
          may not cancel such accepted order without Kriptees’s prior
          ...
          expenses. The product(s) must be returned to Kriptees within
        ...
        <p>
          ...
          indemnify and hold Kriptees harmless from and against any and all
        ...
        <p style={{ fontWeight: "500" }}>Kriptees</p>
        <p style={{ fontWeight: "500" }}>123 Main Street, City, Country</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>info@Kriptees.com</span>
        </p>
      </div>
    </div>
  );
