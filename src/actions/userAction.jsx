...
export const getUserDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://ecomm-backend-o6x0.onrender.com/api/v1/admin/user/${id}`, config);
...
export const deleteUser = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`https://ecomm-backend-o6x0.onrender.com/api/v1/admin/user/${id}`, config);
